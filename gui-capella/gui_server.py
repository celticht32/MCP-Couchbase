...
def config():
    ...
    if request.method == "POST":
        ...
        return jsonify({
            ...
            "CAPELLA_BASE_URL":       os.environ.get("CAPELLA_BASE_URL", "https://cloudapi.cloud.couchbase.com"),
...
if __name__ == "__main__":
    ...
    print(f"  ({'CAPELLA_API_KEY_SECRET is set' if os.environ.get('CAPELLA_API_KEY_SECRET') else 'WARNING: CAPELLA_API_KEY_SECRET not set — set via UI or env'})\n")
